...
//                self.isNumberLabel.isEnabled = true
//                self.isLowercaseLabel.isEnabled = true
//                self.isUppercaseLabel.isEnabled = true
//                self.isSymbolLabel.isEnabled = true
//                val.forEach { char in
//                    if (char.isNumber) { self.isNumberLabel.isEnabled = false }
//                    if (char.isLowercase) { self.isLowercaseLabel.isEnabled = false }
//                    if (char.isUppercase) { self.isUppercaseLabel.isEnabled = false }
//                    if (["!","#","$","*","(",")","-","=","_","+",".",","].contains(char) ) {
//                        self.isSymbolLabel.isEnabled = false }
//                    }
//                self.isPasswordNumber.accept(self.isNumberLabel.isEnabled)
//                self.isPasswordLowercase.accept(self.isLowercaseLabel.isEnabled)
//                self.isPasswordUppercase.accept(self.isUppercaseLabel.isEnabled)
//                self.isPasswordSymbol.accept(self.isSymbolLabel.isEnabled)
